...
public class HelpFormatter {
    ...
    private static final Comparator<OptionSpec> optComparator = Utils.comparing(OptionSpec::firstName);
    private static final Comparator<OptionGroupSpec> groupComparator = Utils.comparing(OptionGroupSpec::getName);
